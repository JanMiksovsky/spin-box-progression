/*
 * General type declarations for lib.
 *
 * lib is a JavaScript project, but we use TypeScript as an internal tool to
...
/*
 * An lib mixin is a function that takes an existing class and returns a new
 * class.
 *
